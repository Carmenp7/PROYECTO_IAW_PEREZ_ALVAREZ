...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  <a class="navbar-brand" href="principal.php">AUTOINYECCION DIESEL</a>
  <ul class="navbar-nav">
    <li class="nav-item">
    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu">
        <a class="dropdown-item" href="">Mecánica básica</a>
        <a class="dropdown-item" href="">Mecánica Especializa</a>
