...
<html>
    ...
    <link rel="stylesheet" href="eliminar_empleados.css" TYPE="text/css" MEDIA=screen>
    ...
    <?php if (!isset($_POST["borrar"])) : ?>
            ...
            <div class="main-div row">
                <div id="pregunta"class="col-md-12" style="background-color: white; border-radius: 5px; margin-left: 250px; margin-top: 10px;">
                    <center><h4>¿Estás seguro de eliminar este empleado ?</h4></center>
        ...
        <?php 
          ...
          $consulta="DELETE from empleados where CodEmpleado=$_GET[CodEmpleado]";

        
                if ($result = $connection->query($consulta)) {
                    header("refresh:0;url=empleados_admin.php");
                }
               else {
                    header("refresh:0;url=eliminar_empleados.php");
