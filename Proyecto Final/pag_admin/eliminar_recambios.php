...
<html>
    ...
    <link rel="stylesheet" href="/Proyecto%20Final/css/eliminar_recambios.css" TYPE="text/css" MEDIA=screen>
    ...
    <?php if (!isset($_POST["eliminar"])) : ?>
            ...
            <div class="main-div row">
                <div id="pregunta"class="col-md-12" style="background-color: white; border-radius: 5px; margin-left: 250px; margin-top: 10px;">
                    <center><h4>¿Estás seguro de eliminar este recambio ?</h4></center>
        ...
        <?php 
          ...
          $consulta="DELETE from recambios where IdRecambio=$_GET[IdRecambio]";

        
                if ($result = $connection->query($consulta)) {
                    header("refresh:0;url=recambios_admin.php");
                }
               else {
                    header("refresh:0;url=eliminar_recambios.php");
